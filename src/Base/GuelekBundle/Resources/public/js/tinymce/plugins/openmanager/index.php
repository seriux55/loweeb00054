...
?>
	<ul class="nav nav-tabs">
			...
			if($mediatype=="media")
			{
				$ubuttontext = "media";
			?>
                <li<?php if(isset($tabno)){ echo ($tabno==1)?" class=\"active\"":""; } ?>><a href="#home" data-toggle="tab">Upload Media</a></li>
                <li<?php if(isset($tabno)){ echo ($tabno==2)?" class=\"active\"":""; } ?>><a href="#media" data-toggle="tab">Browse Media</a></li>
			<?php
			}
			else
			{
